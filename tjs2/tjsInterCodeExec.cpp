...
//---------------------------------------------------------------------------
static void GetStringProperty(tTJSVariant* result,
                              const tTJSVariant* str,
                              const tTJSVariant& member)
{
    ...
    if (member.Type() != tvtInteger && member.Type() != tvtReal)
    {
        ...
        if (!name)
            TJSThrowFrom_tjs_error(TJS_E_MEMBERNOTFOUND, TJS_N(""));

        if (!TJS_strcmp(name, TJS_N("length")))
        {
            // get string length
            ...
            if (!s)
                ...
                *result = tTVInteger(s->GetCharLength());
            return;
        }
        else if (name[0] >= TJS_N('0') && name[0] <= TJS_N('9'))
        {
            ...
            if (n == len)
            {
                *result = tTJSVariant(TJS_N(""));
                return;
            }
            if (n < 0 || n > len)
                TJS_eTJSError(TJSRangeError);
            const tjs_char* ss = utf8_char_get(s, n);
            if (!ss)
            {
                *result = tTJSVariant(TJS_N(""));
                return;
            }
            tjs_int ssLen = utf8_char_len(ss);
            *result = tTJSVariant(ttstr(ss, ssLen));
            return;
        }
...
//---------------------------------------------------------------------------
static void SetStringProperty(tTJSVariant* param, const tTJSVariant* str, const tTJSVariant& member)
{
    // processes properties toward strings.
    if (member.Type() != tvtInteger && member.Type() != tvtReal)
    {
        ...
        if (!TJS_strcmp(name, TJS_N("length")))
        {
            TJSThrowFrom_tjs_error(TJS_E_ACCESSDENYED, TJS_N(""));
        }
        else if (name[0] >= TJS_N('0') && name[0] <= TJS_N('9'))
        {
            TJSThrowFrom_tjs_error(TJS_E_ACCESSDENYED, TJS_N(""));
...
//---------------------------------------------------------------------------
static void GetOctetProperty(tTJSVariant* result,
                             const tTJSVariant* octet,
                             const tTJSVariant& member)
{
...
//---------------------------------------------------------------------------
static void SetOctetProperty(tTJSVariant* param,
                             const tTJSVariant* octet,
                             const tTJSVariant& member)
{
    // processes properties toward octets.
...
#define OBJ2 ((objthis) ? (objthis) : (Dispatch2))
    ...
    {
        tjs_error hr = Dispatch1->FuncCall(flag, membername, hint, result, numparams, param, OBJ1);
    ...
    tjs_error FuncCallByNum(tjs_uint32 flag,
                            ...
                            iTJSDispatch2* objthis)
    {
        tjs_error hr = Dispatch1->FuncCallByNum(flag, num, result, numparams, param, OBJ1);
        if (hr == TJS_E_MEMBERNOTFOUND && Dispatch1 != Dispatch2)
    ...
    tjs_error PropGet(tjs_uint32 flag,
                      ...
                      iTJSDispatch2* objthis)
    {
        tjs_error hr = Dispatch1->PropGet(flag, membername, hint, result, OBJ1);
        if (hr == TJS_E_MEMBERNOTFOUND && Dispatch1 != Dispatch2)
    ...
    tjs_error PropSet(tjs_uint32 flag,
                      ...
                      iTJSDispatch2* objthis)
    {
        tjs_error hr = Dispatch1->PropSet(flag, membername, hint, param, OBJ1);
        if (hr == TJS_E_MEMBERNOTFOUND && Dispatch1 != Dispatch2)
    ...
    tjs_error GetCountByNum(tjs_int* result, tjs_int num, iTJSDispatch2* objthis)
    {
    ...
    tjs_error PropSetByVS(tjs_uint32 flag,
                          ...
                          iTJSDispatch2* objthis)
    {
        tjs_error hr = Dispatch1->PropSetByVS(flag, membername, param, OBJ1);
        if (hr == TJS_E_MEMBERNOTFOUND && Dispatch1 != Dispatch2)
            return Dispatch2->PropSetByVS(flag, membername, param, OBJ2);
        return hr;
    }

    tjs_error EnumMembers(tjs_uint32 flag, tTJSVariantClosure* callback, iTJSDispatch2* objthis)
    {
    ...
    tjs_error DeleteMember(tjs_uint32 flag,
                           ...
                           iTJSDispatch2* objthis)
    {
        tjs_error hr = Dispatch1->DeleteMember(flag, membername, hint, OBJ1);
        if (hr == TJS_E_MEMBERNOTFOUND && Dispatch1 != Dispatch2)
            return Dispatch2->DeleteMember(flag, membername, hint, OBJ2);
        return hr;
    }

    tjs_error DeleteMemberByNum(tjs_uint32 flag, tjs_int num, iTJSDispatch2* objthis)
    {
    ...
    tjs_error InvalidateByNum(tjs_uint32 flag, tjs_int num, iTJSDispatch2* objthis)
    {
    ...
    tjs_error IsValidByNum(tjs_uint32 flag, tjs_int num, iTJSDispatch2* objthis)
    {
    ...
    tjs_error CreateNew(tjs_uint32 flag,
                        ...
                        iTJSDispatch2* objthis)
    {
        tjs_error hr = Dispatch1->CreateNew(flag, membername, hint, result, numparams, param, OBJ1);
        if (hr == TJS_E_MEMBERNOTFOUND && Dispatch1 != Dispatch2)
    ...
    tjs_error CreateNewByNum(tjs_uint32 flag,
                             ...
                             iTJSDispatch2* objthis)
    {
        tjs_error hr = Dispatch1->CreateNewByNum(flag, num, result, numparams, param, OBJ1);
        if (hr == TJS_E_MEMBERNOTFOUND && Dispatch1 != Dispatch2)
    ...
    tjs_error IsInstanceOf(tjs_uint32 flag,
                           ...
                           iTJSDispatch2* objthis)
    {
        tjs_error hr = Dispatch1->IsInstanceOf(flag, membername, hint, classname, OBJ1);
        if (hr == TJS_E_MEMBERNOTFOUND && Dispatch1 != Dispatch2)
            return Dispatch2->IsInstanceOf(flag, membername, hint, classname, OBJ2);
        return hr;
    }

    tjs_error IsInstanceOfByNum(tjs_uint32 flag,
                                tjs_int num,
                                const tjs_char* classname,
                                iTJSDispatch2* objthis)
    {
        tjs_error hr = Dispatch1->IsInstanceOfByNum(flag, num, classname, OBJ1);
        if (hr == TJS_E_MEMBERNOTFOUND && Dispatch1 != Dispatch2)
    ...
    tjs_error Operation(tjs_uint32 flag,
                        ...
                        iTJSDispatch2* objthis)
    {
        tjs_error hr = Dispatch1->Operation(flag, membername, hint, result, param, OBJ1);
        if (hr == TJS_E_MEMBERNOTFOUND && Dispatch1 != Dispatch2)
    ...
    tjs_error OperationByNum(tjs_uint32 flag,
                             ...
                             iTJSDispatch2* objthis)
    {
        tjs_error hr = Dispatch1->OperationByNum(flag, num, result, param, OBJ1);
        if (hr == TJS_E_MEMBERNOTFOUND && Dispatch1 != Dispatch2)
...
void tTJSVariantArrayStack::IncreaseVariantArray(tjs_int num)
{
    ...
    {
        Arrays = (tVariantArray*)TJS_realloc(Arrays, sizeof(tVariantArray) * (NumArraysUsing));
...
void tTJSVariantArrayStack::InternalCompact(void)
{
    ...
    try
    {
        ...
        else
        {
            ...
            tVariantArray* arraytmp =
                (tVariantArray*)TJS_realloc(Arrays, sizeof(tVariantArray) * (NumArraysUsing));
            if (arraytmp != NULL)
            {
                Arrays = arraytmp;
            }
                                             ...
                                             tjs_int start_ip)
{
    ...
    try
    {
        ...
        try
        {
            ...
            TJSDebuggerGetScopeKey(DebuggerScopeKey, GetClassName().c_str(), GetName(),
                                   Block->GetName(), start_ip);
...
void tTJSInterCodeContext::DisplayExceptionGeneratedCode(tjs_int codepos, const tTJSVariant* ra)
{
    ...
    ttstr info(TJS_N("==== An exception occured at ") + GetPositionDescriptionString(codepos) +
               TJS_N(", VM ip = ") + ttstr(codepos) + TJS_N(" ===="));
    tjs_int info_len = info.GetLen();

    tjs->OutputToConsole(info.c_str());
    tjs->OutputToConsole(TJS_N("-- Disassembled VM code --"));
    DisassembleSrcLine(codepos);

    tjs->OutputToConsole(TJS_N("-- Register dump --"));
    ...
    {
        ttstr reg_info = TJS_N("%") + ttstr(i - (MaxVariableCount + VariableReserveCount)) +
                         TJS_N("=") + TJSVariantToReadableString(ra_start[i]);
    ...
    tjs->OutputToConsoleSeparator(TJS_N("-"), info_len);
}
//---------------------------------------------------------------------------
    ...
    if (val.Type() == tvtObject)
    {
        try
        {
            ...
            if (clo.Object != NULL)
            {
                ...
                tjs_error hr =
                    clo.PropGet(0, message_name.c_str(), message_name.GetHint(), &v2, NULL);
                if (TJS_SUCCEEDED(hr))
                {
                    msg = ttstr(TJS_N("script exception : ")) + ttstr(v2);
                }
            }
        }
        catch (...)
...
#undef TJS_DEF_VM_P
                    ...
                    TJS_GET_VM_REG(ra, code[1]) =
                        TJS_GET_VM_REG(ra, code[1]).Type() != tvtObject
                            ...
                            : (TJS_GET_VM_REG(ra, code[1])
                                   ...
                                   .Invalidate(0, NULL, NULL, ra[-1].AsObjectNoAddRef()) ==
                               TJS_S_TRUE);
                    code += 2;
                    break;
                    ...
                    TJS_GET_VM_REG(ra, code[1]) =
                        TJS_GET_VM_REG(ra, code[1]).Type() != tvtObject
                            ...
                            : TJSIsObjectValid(
                                  TJS_GET_VM_REG(ra, code[1])
                                      .AsObjectClosureNoAddRef()
                                      .IsValid(0, NULL, NULL, ra[-1].AsObjectNoAddRef()));
                    code += 2;
                    break;
                ...
                case VM_EVAL:
                    Eval(TJS_GET_VM_REG(ra, code[1]),
                         TJSEvalOperatorIsOnGlobal ? NULL : ra[-1].AsObjectNoAddRef(), true);
                    code += 2;
                    break;

                case VM_EEXP:
                    Eval(TJS_GET_VM_REG(ra, code[1]),
                         TJSEvalOperatorIsOnGlobal ? NULL : ra[-1].AsObjectNoAddRef(), false);
                    code += 2;
                    break;

                case VM_CHKINS:
                    InstanceOf(TJS_GET_VM_REG(ra, code[2]), TJS_GET_VM_REG(ra, code[1]));
                    code += 3;
                    break;
                ...
                case VM_ENTRY:
                    code =
                        CodeArea + ExecuteCodeInTryBlock(
                                       ra, (tjs_int)(code - CodeArea + 3), args, numargs, result,
                                       (tjs_int)(TJS_FROM_VM_CODE_ADDR(code[1]) + code - CodeArea),
                ...
                case VM_CHGTHIS:
                    TJS_GET_VM_REG(ra, code[1])
                        .ChangeClosureObjThis(TJS_GET_VM_REG(ra, code[2]).AsObjectNoAddRef());
                    code += 3;
                    break;
...
//---------------------------------------------------------------------------
tjs_int tTJSInterCodeContext::ExecuteCodeInTryBlock(tTJSVariant* ra,
                                                    tjs_int startip,
                                                    tTJSVariant** args,
                                                    tjs_int numargs,
                                                    tTJSVariant* result,
                                                    ...
                                                    tjs_int exobjreg)
{
    ...
    TJS_CONVERT_TO_TJS_EXCEPTION_OBJECT(
        Block->GetTJS(), exobjreg, ra + exobjreg, { ; }, { return catchip; })
}
//---------------------------------------------------------------------------
void tTJSInterCodeContext::ContinuousClear(tTJSVariant* ra, const tjs_int32* code)
{
                                             ...
                                             tjs_uint32 flags)
{
    ...
    hr = clo.PropGet(flags, name->GetString(), name->GetHint(), TJS_GET_VM_REG_ADDR(ra, code[1]),
                                             ...
                                             tjs_uint32 flags)
{
    ...
    hr = clo.PropSetByVS(flags, name->AsStringNoAddRef(), TJS_GET_VM_REG_ADDR(ra, code[3]),
                         clo.ObjThis ? clo.ObjThis : ra[-1].AsObjectNoAddRef());
    if (hr == TJS_E_NOTIMPL)
        hr =
            clo.PropSet(flags, name->GetString(), name->GetHint(), TJS_GET_VM_REG_ADDR(ra, code[3]),
                        clo.ObjThis ? clo.ObjThis : ra[-1].AsObjectNoAddRef());
    if (TJS_FAILED(hr))
...
{
    // ra[code[1]] = * ra[code[2]]
    tTJSVariantClosure clo = TJS_GET_VM_REG_ADDR(ra, code[2])->AsObjectClosureNoAddRef();
    tjs_error hr;
...
{
    // * ra[code[1]] = ra[code[2]]
    tTJSVariantClosure clo = TJS_GET_VM_REG_ADDR(ra, code[1])->AsObjectClosureNoAddRef();
    tjs_error hr;
                                               ...
                                               tjs_uint32 flags)
{
    ...
    if (type == tvtString)
    {
        GetStringProperty(TJS_GET_VM_REG_ADDR(ra, code[1]), ra_code2, TJS_GET_VM_REG(ra, code[3]));
        return;
    }
    if (type == tvtOctet)
    {
        GetOctetProperty(TJS_GET_VM_REG_ADDR(ra, code[1]), ra_code2, TJS_GET_VM_REG(ra, code[3]));
        return;
    }
    ...
    if (ra_code3->Type() != tvtInteger)
    {
        ...
        try
        {
            ...
            {
                hr = clo.PropGet(flags, NULL, NULL, TJS_GET_VM_REG_ADDR(ra, code[1]),
                                 clo.ObjThis ? clo.ObjThis : ra[-1].AsObjectNoAddRef());
                if (TJS_FAILED(hr))
                    TJSThrowFrom_tjs_error(hr, NULL);
            }
                                               ...
                                               tjs_uint32 flags)
{
    ...
    if (type == tvtString)
    {
        SetStringProperty(TJS_GET_VM_REG_ADDR(ra, code[3]), TJS_GET_VM_REG_ADDR(ra, code[1]),
                          TJS_GET_VM_REG(ra, code[2]));
        return;
    }
    if (type == tvtOctet)
    {
        SetOctetProperty(TJS_GET_VM_REG_ADDR(ra, code[3]), TJS_GET_VM_REG_ADDR(ra, code[1]),
                         TJS_GET_VM_REG(ra, code[2]));
        return;
    }
    ...
    if (ra_code2->Type() != tvtInteger)
    {
        ...
        try
        {
            hr = clo.PropSetByVS(flags, str, TJS_GET_VM_REG_ADDR(ra, code[3]),
                                 clo.ObjThis ? clo.ObjThis : ra[-1].AsObjectNoAddRef());
            if (hr == TJS_E_NOTIMPL)
            {
                if (str)
                {
                    hr = clo.PropSet(flags, *str, NULL, TJS_GET_VM_REG_ADDR(ra, code[3]),
                                     clo.ObjThis ? clo.ObjThis : ra[-1].AsObjectNoAddRef());
                    if (TJS_FAILED(hr))
                        TJSThrowFrom_tjs_error(hr, *str);
                }
                ...
                {
                    hr = clo.PropSet(flags, NULL, NULL, TJS_GET_VM_REG_ADDR(ra, code[3]),
                                     clo.ObjThis ? clo.ObjThis : ra[-1].AsObjectNoAddRef());
                    if (TJS_FAILED(hr))
                        TJSThrowFrom_tjs_error(hr, NULL);
                }
                                                   ...
                                                   tjs_uint32 ope)
{
    ...
    if (ra_code3->Type() != tvtInteger)
    {
        ...
        try
        {
            ...
            {
                hr = clo.Operation(ope, NULL, NULL,
                                   code[1] ? TJS_GET_VM_REG_ADDR(ra, code[1]) : NULL,
                                   TJS_GET_VM_REG_ADDR(ra, code[4]),
                                   clo.ObjThis ? clo.ObjThis : ra[-1].AsObjectNoAddRef());
                if (TJS_FAILED(hr))
    ...
    else
    {
        ...
        try
        {
            hr = clo.OperationByNum(ope, (tjs_int)ra_code3->AsInteger(),
                                    ...
                                    clo.ObjThis ? clo.ObjThis : ra[-1].AsObjectNoAddRef());
            if (TJS_FAILED(hr))
                ThrowFrom_tjs_error_num(hr, (tjs_int)TJS_GET_VM_REG(ra, code[3]).AsInteger());
        }
        catch (...)
        {
            clo.Release();
...
//---------------------------------------------------------------------------
void tTJSInterCodeContext::OperateProperty(tTJSVariant* ra, const tjs_int32* code, tjs_uint32 ope)
{
    ...
    try
    {
        hr = clo.Operation(ope, NULL, NULL, code[1] ? TJS_GET_VM_REG_ADDR(ra, code[1]) : NULL,
                           TJS_GET_VM_REG_ADDR(ra, code[3]),
                           clo.ObjThis ? clo.ObjThis : ra[-1].AsObjectNoAddRef());
    }
    catch (...)
...
//---------------------------------------------------------------------------
void tTJSInterCodeContext::OperateProperty0(tTJSVariant* ra, const tjs_int32* code, tjs_uint32 ope)
{
    ...
    try
    {
        hr = clo.Operation(ope, NULL, NULL, code[1] ? TJS_GET_VM_REG_ADDR(ra, code[1]) : NULL, NULL,
                           clo.ObjThis ? clo.ObjThis : ra[-1].AsObjectNoAddRef());
    }
    catch (...)
    {
...
//---------------------------------------------------------------------------
void tTJSInterCodeContext::DeleteMemberDirect(tTJSVariant* ra, const tjs_int32* code)
{
    ...
    {
        tTJSVariant* name = TJS_GET_VM_REG_ADDR(DataArea, code[3]);
        hr = clo.DeleteMember(0, name->GetString(), name->GetHint(), ra[-1].AsObjectNoAddRef());
    }
    catch (...)
    {
        clo.Release();
...
//---------------------------------------------------------------------------
void tTJSInterCodeContext::DeleteMemberIndirect(tTJSVariant* ra, const tjs_int32* code)
{
    ...
    try
    {
        if (str)
            ...
            hr = clo.DeleteMember(0, NULL, NULL,
                                  clo.ObjThis ? clo.ObjThis : ra[-1].AsObjectNoAddRef());
        if (code[1])
        {
            if (TJS_FAILED(hr))
                                              ...
                                              tjs_uint32 flags)
{
    ...
    if (type == tvtString)
    {
        GetStringProperty(TJS_GET_VM_REG_ADDR(ra, code[1]), TJS_GET_VM_REG_ADDR(ra, code[2]),
                          TJS_GET_VM_REG(DataArea, code[3]));
        TypeOf(TJS_GET_VM_REG(ra, code[1]));
        return;
    }
    if (type == tvtOctet)
    {
        GetOctetProperty(TJS_GET_VM_REG_ADDR(ra, code[1]), TJS_GET_VM_REG_ADDR(ra, code[2]),
                         TJS_GET_VM_REG(DataArea, code[3]));
        TypeOf(TJS_GET_VM_REG(ra, code[1]));
        return;
    }
    ...
    try
    {
        tTJSVariant* name = TJS_GET_VM_REG_ADDR(DataArea, code[3]);
        hr =
            clo.PropGet(flags, name->GetString(), name->GetHint(), TJS_GET_VM_REG_ADDR(ra, code[1]),
                        clo.ObjThis ? clo.ObjThis : ra[-1].AsObjectNoAddRef());
    }
    catch (...)
    {
    ...
    {
        static tTJSString undefined_name(TJSMapGlobalStringMap(TJS_N("undefined")));
                                                ...
                                                tjs_uint32 flags)
{
    ...
    else
    {
        try
        {
            hr = clo.PropGetByNum(flags, (tjs_int)TJS_GET_VM_REG(ra, code[3]).AsInteger(),
                                  TJS_GET_VM_REG_ADDR(ra, code[1]),
                                  clo.ObjThis ? clo.ObjThis : ra[-1].AsObjectNoAddRef());
            if (hr == TJS_S_OK)
            {
    ...
    { \
        ...
        { \
            ...
            if (pass_args_count < TJS_PASS_ARGS_PREPARED_ARRAY_COUNT) \
                ...
                pass_args = new tTJSVariant*[pass_args_count], alloc_args = true; \
...
\
                    ...
                    case fatUnnamedExpand: \
                    { \
                        tjs_int count = (numargs > FuncDeclUnnamedArgArrayBase) \
                                            ? (numargs - FuncDeclUnnamedArgArrayBase) \
                                            : 0; \
                        for (tjs_int j = 0; j < count; j++) \
                                           ...
                                           tjs_int numargs)
{
    ...
    try
    {
        if (code[0] == VM_CALL)
        {
            hr = clo.FuncCall(0, NULL, NULL, code[1] ? TJS_GET_VM_REG_ADDR(ra, code[1]) : NULL,
        ...
        {
            iTJSDispatch2* dsp;
            hr = clo.CreateNew(0, NULL, NULL, &dsp, pass_args_count, pass_args,
                               clo.ObjThis ? clo.ObjThis : ra[-1].AsObjectNoAddRef());
            if (TJS_SUCCEEDED(hr))
            {
                if (dsp)
    ...
    if (TJS_FAILED(hr))
        TJSThrowFrom_tjs_error(hr, TJS_N(""));
                                                 ...
                                                 tjs_int numargs)
{
    ...
    if (type == tvtString)
    {
        ProcessStringFunction(name->GetString(), TJS_GET_VM_REG(ra, code[2]), pass_args,
                              pass_args_count, code[1] ? TJS_GET_VM_REG_ADDR(ra, code[1]) : NULL);
        hr = TJS_S_OK;
    }
    else if (type == tvtOctet)
    {
        ProcessOctetFunction(name->GetString(), TJS_GET_VM_REG(ra, code[2]).AsOctetNoAddRef(),
                             pass_args, pass_args_count,
                             code[1] ? TJS_GET_VM_REG_ADDR(ra, code[1]) : NULL);
        hr = TJS_S_OK;
    }
    else
    {
        ...
        try
        {
            hr = clo.FuncCall(0, name->GetString(), name->GetHint(),
                              code[1] ? TJS_GET_VM_REG_ADDR(ra, code[1]) : NULL, pass_args_count,
                              pass_args, clo.ObjThis ? clo.ObjThis : ra[-1].AsObjectNoAddRef());
        }
        catch (...)
        {
            clo.Release();
    ...
    if (TJS_FAILED(hr))
        TJSThrowFrom_tjs_error(hr, ttstr(TJS_GET_VM_REG(DataArea, code[3])).c_str());
                                                   ...
                                                   tjs_int numargs)
{
    ...
    if (type == tvtString)
    {
        ProcessStringFunction(name.c_str(), TJS_GET_VM_REG(ra, code[2]), pass_args, pass_args_count,
                              code[1] ? TJS_GET_VM_REG_ADDR(ra, code[1]) : NULL);
        hr = TJS_S_OK;
    }
    else if (type == tvtOctet)
    {
        ProcessOctetFunction(name.c_str(), TJS_GET_VM_REG(ra, code[2]).AsOctetNoAddRef(), pass_args,
                             pass_args_count, code[1] ? TJS_GET_VM_REG_ADDR(ra, code[1]) : NULL);
        hr = TJS_S_OK;
    }
    else
    {
        ...
        try
        {
            hr = clo.FuncCall(0, name.c_str(), name.GetHint(),
                              code[1] ? TJS_GET_VM_REG_ADDR(ra, code[1]) : NULL, pass_args_count,
                              pass_args, clo.ObjThis ? clo.ObjThis : ra[-1].AsObjectNoAddRef());
        }
        catch (...)
...
//---------------------------------------------------------------------------
void tTJSInterCodeContext::AddClassInstanceInfo(tTJSVariant* ra, const tjs_int32* code)
{
    iTJSDispatch2* dsp;
...
//---------------------------------------------------------------------------
static const tjs_char* StrFuncs[] = {TJS_N("charAt"),      TJS_N("indexOf"),   TJS_N("toUpperCase"),
                                     TJS_N("toLowerCase"), TJS_N("substring"), TJS_N("substr"),
                                     TJS_N("sprintf"),     TJS_N("replace"),   TJS_N("escape"),
                                     TJS_N("split"),       TJS_N("trim"),      TJS_N("reverse"),
                                     TJS_N("repeat")};
                                                 ...
                                                 tTJSVariant* result)
{
    ...
    const tjs_int s_len = target.GetCharLen();
...
#define TJS_STR_METHOD_IS(_name) \
    ...
    if (TJS_STR_METHOD_IS(charAt))
    {
        ...
        const tjs_char* bt = utf8_char_get(s, i);
        if (!bt)
        {
            *result = tTJSVariant(TJS_N(""));
            return;
        }
        tjs_int btLen = utf8_char_len(bt);
        if (result)
            *result = tTJSVariant(ttstr(bt, btLen));
        return;
    }
    else if (TJS_STR_METHOD_IS(indexOf))
    {
        ...
        if (result)
            *result = utf8_indexOf(s, (const tjs_char*)*pstr, start);
        if (pstr)
            pstr->Release();
        return;
    }
    ...
    else if (TJS_STR_METHOD_IS(substring) || TJS_STR_METHOD_IS(substr))
    {
        ...
        if (numargs == 2)
        {
            ...
            int retStrLen = 0;
            const char* retStr = utf8_substr(s, start, count, retStrLen);
            if (result)
                *result = ttstr(retStr, retStrLen);
        }
        else
        {
            int retStrLen = 0;
            const char* retStr = utf8_substr(s, start, -1, retStrLen);
            if (result)
                *result = ttstr(retStr, retStrLen);
        }
        return;
    ...
    else if (TJS_STR_METHOD_IS(replace))
    {
        ...
        static tTJSString replace_name(TJS_N("replace"));
        clo.FuncCall(0, replace_name.c_str(), replace_name.GetHint(), result, 2, params, NULL);
    ...
    else if (TJS_STR_METHOD_IS(split))
    {
        ...
        try
        {
            ...
            static tTJSString split_name(TJS_N("split"));
            array->FuncCall(0, split_name.c_str(), split_name.GetHint(), NULL, arg_count, params,
                            array);
    ...
    else if (TJS_STR_METHOD_IS(trim))
    {
        ...
        tjs_int w_len = target.GetLen();
        const tjs_char* src = s + w_len - 1;
        /*  s/\s+$//;  */
...
//---------------------------------------------------------------------------
void tTJSInterCodeContext::ProcessOctetFunction(const tjs_char* member,
                                                ...
                                                tTJSVariant* result)
{
    ...
    {
        case 'u':
            if (!TJS_strcmp(TJS_N("unpack"), member))
            {
...
void tTJSInterCodeContext::TypeOf(tTJSVariant& val)
{
    ...
    static tTJSString void_name(TJSMapGlobalStringMap(TJS_N("void")));
    static tTJSString Object_name(TJSMapGlobalStringMap(TJS_N("Object")));
    static tTJSString String_name(TJSMapGlobalStringMap(TJS_N("String")));
    static tTJSString Integer_name(TJSMapGlobalStringMap(TJS_N("Integer")));
    static tTJSString Real_name(TJSMapGlobalStringMap(TJS_N("Real")));
    static tTJSString Octet_name(TJSMapGlobalStringMap(TJS_N("Octet")));
...
//---------------------------------------------------------------------------
void tTJSInterCodeContext::Eval(tTJSVariant& val, iTJSDispatch2* objthis, bool resneed)
{
    if (objthis)
        objthis->AddRef();
    try
                           ...
                           iTJSDispatch2* objthis)
        {
            ...
            if (!(flags & TJS_STATICMEMBER))
            {
                ...
                if (Dest->PropSetByVS(TJS_MEMBERENSURE | TJS_IGNOREPROP | flags,
                    ...
                    Dest->PropSet(TJS_MEMBERENSURE | TJS_IGNOREPROP | flags, param[0]->GetString(),
                                  NULL, &val, Dest);
            }
            if (result)
...
tjs_error tTJSInterCodeContext::FuncCall(tjs_uint32 flag,
                                         const tjs_char* membername,
                                         tjs_uint32* hint,
                                         tTJSVariant* result,
                                         tjs_int numparams,
                                         ...
                                         iTJSDispatch2* objthis)
{
    ...
    if (membername == NULL)
    {
        ...
        {
            case ctTopLevel:
                ExecuteAsFunction(objthis ? objthis : Block->GetTJS()->GetGlobalNoAddRef(), NULL, 0,
                                  result, 0);
                break;
    ...
    if (membername != NULL && hr == TJS_E_MEMBERNOTFOUND && ContextType == ctClass &&
        SuperClassGetter)
    {
        // look up super class
        TJS_DO_SUPERCLASS_PROXY_BEGIN
        hr = clo.FuncCall(flag, membername, hint, result, numparams, param, objthis);
                                        ...
                                        iTJSDispatch2* objthis)
{
    ...
    if (membername == NULL)
    {
        if (ContextType == ctProperty)
        {
            ...
            if (PropGetter)
                return PropGetter->FuncCall(0, NULL, NULL, result, 0, NULL, objthis);
            else
                                        ...
                                        iTJSDispatch2* objthis)
{
    ...
    {
        tjs_uint32 pseudo_flag = (flag & TJS_IGNOREPROP) ? flag : (flag & ~TJS_MEMBERENSURE);
        // member ensuring is temporarily disabled unless TJS_IGNOREPROP

        hr = inherited::PropSet(pseudo_flag, membername, hint, param, objthis);
        if (hr == TJS_E_MEMBERNOTFOUND)
        {
            TJS_DO_SUPERCLASS_PROXY_BEGIN
                                          ...
                                          iTJSDispatch2* objthis)
{
        ...
        SuperClassGetter)
    {
        // look up super class
        TJS_DO_SUPERCLASS_PROXY_BEGIN
        hr = clo.CreateNew(flag, membername, hint, result, numparams, param, objthis);
        TJS_DO_SUPERCLASS_PROXY_END
    }
    return hr;
}
                                             ...
                                             iTJSDispatch2* objthis)
{
    ...
    if (membername == NULL)
    {
        switch (ContextType)
        {
            ...
            case ctFunction:
            case ctExprFunction:
                if (!TJS_strcmp(classname, TJS_N("Function")))
                    return TJS_S_TRUE;
                break;

            case ctProperty:
                if (!TJS_strcmp(classname, TJS_N("Property")))
                    return TJS_S_TRUE;
                break;

            case ctClass:
                if (!TJS_strcmp(classname, TJS_N("Class")))
                    return TJS_S_TRUE;
                break;
        }
    }
...
//---------------------------------------------------------------------------
tjs_error tTJSInterCodeContext::Operation(tjs_uint32 flag,
                                          const tjs_char* membername,
                                          tjs_uint32* hint,
                                          tTJSVariant* result,
                                          const tTJSVariant* param,
                                          iTJSDispatch2* objthis)
{
    if (membername == NULL)
    {
        if (ContextType == ctProperty)
        {
            ...
            return tTJSDispatch::Operation(flag, membername, hint, result, param, objthis);
        }
        else
        {
    ...
    if (membername != NULL && ContextType == ctClass && SuperClassGetter)
    {
        ...
        tjs_error hr = inherited::Operation(pseudo_flag, membername, hint, result, param, objthis);

        if (hr == TJS_E_MEMBERNOTFOUND)
        {
            // look up super class
            TJS_DO_SUPERCLASS_PROXY_BEGIN
            hr = clo.Operation(pseudo_flag, membername, hint, result, param, objthis);
            TJS_DO_SUPERCLASS_PROXY_END
        }
