...
tjs_int TJS_timezone()
{
    ...
    gmtime_s(&utc_tm, &now);
#elif defined(_KRKRSDL3_ANDROID) || defined(_KRKRSDL3_LINUX)  || defined(_KRKRSDL3_OHOS) || defined(_KRKRSDL3_IOS) || defined(_KRKRSDL3_MACOS) || defined(_KRKRSDL3_EMSCRIPTEN)
