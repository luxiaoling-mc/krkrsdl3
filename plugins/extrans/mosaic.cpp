...
public:
    tTVPMosaicTransHandler(tjs_uint64 time, tjs_int width, tjs_int height, tjs_int maxblocksize)
    {
        RefCount = 1;
    ...
    { \
        ...
        { \
            case 2: \
                do \
                { \
                    ((tjs_uint32*)__destp)[0] = ((tjs_uint32*)__destp)[1] = color; \
                    __destp += destpitch; \
                } while (--__count); \
                break; \
            case 3: \
                do \
                { \
                    ((tjs_uint32*)__destp)[0] = ((tjs_uint32*)__destp)[1] = \
            ...
            case 4: \
                ...
                { \
                    ((tjs_uint32*)__destp)[0] = ((tjs_uint32*)__destp)[1] = \
                        ((tjs_uint32*)__destp)[2] = ((tjs_uint32*)__destp)[3] = color; \
                    __destp += destpitch; \
                } while (--__count); \
                break; \
            case 5: \
                ...
                { \
                    ((tjs_uint32*)__destp)[0] = ((tjs_uint32*)__destp)[1] = \
                        ((tjs_uint32*)__destp)[2] = ((tjs_uint32*)__destp)[3] = \
            ...
            case 6: \
                ...
                { \
                    ((tjs_uint32*)__destp)[0] = ((tjs_uint32*)__destp)[1] = \
                        ((tjs_uint32*)__destp)[2] = ((tjs_uint32*)__destp)[3] = \
                            ((tjs_uint32*)__destp)[4] = ((tjs_uint32*)__destp)[5] = color; \
                    __destp += destpitch; \
                } while (--__count); \
                break; \
            case 7: \
                ...
                { \
                    ((tjs_uint32*)__destp)[0] = ((tjs_uint32*)__destp)[1] = \
                        ((tjs_uint32*)__destp)[2] = ((tjs_uint32*)__destp)[3] = \
                            ((tjs_uint32*)__destp)[4] = ((tjs_uint32*)__destp)[5] = \
...
#define FILL_ONE(x, y) \
    { \
        ...
        { \
            ...
            if (my >= Height) \
                my = Height - 1; \
            tjs_uint32 d = Blend(*((const tjs_uint32*)(src1 + my * src1pitch) + mx), \
                                 *((const tjs_uint32*)(src2 + my * src2pitch) + mx), BlendRatio); \
            tjs_uint8* destp = \
                (tjs_uint8*)((tjs_uint32*)(dest + (t + destyofs) * destpitch) + l + destxofs); \
            tjs_int xlen = r - l; \
            tjs_int ylen = b - t; \
    ...
    for (; y < endy; y++)
    {
        ...
        tjs_int l = x * bs + CurOfsX;
        tjs_int t = y * bs + CurOfsY;
        const tjs_uint32* src1p = (const tjs_uint32*)(src1 + (t + bs2) * src1pitch) + (l + bs2);
        const tjs_uint32* src2p = (const tjs_uint32*)(src2 + (t + bs2) * src2pitch) + (l + bs2);
        tjs_uint32* destp = ((tjs_uint32*)(dest + (t + destyofs) * destpitch) + l + destxofs);
